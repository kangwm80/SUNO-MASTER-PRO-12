...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function buildKorCtxPools(t, feeling, atmo, p, targetAge) {
        ...
        // ── Verse: 보편적 노래 가사 내용 + 연령층 말투 ──
        const verseShort = [
            e('그 날처럼', '그 날처럼요', '그 날처럼요'),
            e('눈을 감으면', '눈을 감으면', '눈을 감으면'),
            e('잊을 수 없어', '잊을 수 없어요', '잊을 수 없습니다'),
            e(`${p}에서`, `${p}에서`, `${p}에서`),
            e('말 못 했어', '말 못 했어요', '말 못 했습니다'),
            e('아직도 여기', '아직도 여기', '아직도 여기'),
        ];
        const verseMedium = [
            e('그 날이 아직도 생생하게 남아있어',         '그 날이 아직도 생생하게 남아있어요',         '그 날이 아직도 생생하게 기억납니다'),
            e('말하지 못했던 것들이 가슴에 쌓여만 가',    '말하지 못했던 것들이 가슴에 쌓여만 가요',    '말하지 못했던 것들이 가슴에 남아있습니다'),
            e('눈을 감으면 네 모습이 떠올라',             '눈을 감으면 그 모습이 떠올라요',             '눈을 감으면 그 모습이 떠오릅니다'),
            e(`${p}를 지나칠 때마다 네 생각이 나`,        `${p}를 지나칠 때마다 생각이 나요`,           `${p}를 지나칠 때마다 생각이 납니다`),
            e('익숙한 향기에 그 날이 떠올라',             '익숙한 향기에 그 날이 떠올라요',             '익숙한 향기에 그 날이 떠오릅니다'),
            e('시간이 지나도 이 마음은 그대로야',         '시간이 지나도 이 마음은 그대로예요',         '시간이 지나도 이 마음은 그대로입니다'),
            e('창밖에 비가 내리던 그 날이 생각나',        '창밖에 비가 내리던 그 날이 생각나요',        '창밖에 비가 내리던 그 날이 생각납니다'),
            e('이 감정이 뭔지 나도 설명할 수가 없어',     '이 감정이 뭔지 설명하기가 어려워요',         '이 감정이 무엇인지 설명하기가 어렵습니다'),
        ];
        const verseLong = [
            e('그 날이 아직도 생생해서 잊으려 해도 잊혀지지가 않아',
              '그 날이 아직도 생생해서 잊으려 해도 잊혀지지가 않아요',
              '그 날이 아직도 생생하여 잊으려 해도 잊혀지지가 않습니다'),
            e(`${p}를 지나칠 때마다 그때 그 장면이 눈앞에 펼쳐져`,
              `${p}를 지나칠 때마다 그때 그 장면이 눈앞에 펼쳐져요`,
              `${p}를 지나칠 때마다 그때 그 장면이 눈앞에 펼쳐집니다`),
            e('말하지 못한 진심이 이렇게 노래가 되어 흘러나와',
              '말하지 못한 진심이 이렇게 노래가 되어 흘러나와요',
              '말하지 못한 진심이 이렇게 노래가 되어 흘러나옵니다'),
            e(`${atmo} 공기 속에서 ${feeling}이 밀려오는 게 느껴져`,
              `${atmo} 공기 속에서 ${feeling}이 밀려오는 게 느껴져요`,
              `${atmo} 공기 속에서 ${feeling}이 밀려오는 것이 느껴집니다`),
        ];

        // ── Chorus: 제목 + 보편적 감정 핵심 + 연령층 말투 ──
        const chorusMedium = [
            e(`${t} 네가 보고 싶어`,              `${t} 당신이 보고 싶어요`,            `${t} 당신이 보고 싶습니다`),
            e('이 순간을 영원히 기억할게',         '이 순간을 영원히 기억할게요',        '이 순간을 영원히 기억하겠습니다'),
            e(`${t} 내 마음을 받아줘`,             `${t} 내 마음을 받아줘요`,            `${t} 내 마음을 받아주세요`),
            e(`${feeling}이 담긴 이 노래가 들려`,  `${feeling}이 담긴 이 노래가 들려요`, `${feeling}이 담긴 이 노래가 들립니다`),
            e('이 감정이 진짜라는 걸 알아줘',      '이 감정이 진짜라는 걸 알아줘요',     '이 감정이 진짜라는 걸 알아주세요'),
        ];
        const chorusLong = [
            e(`${t} 이 노래가 너에게 전해지길 바라`,
              `${t} 이 노래가 당신에게 전해지길 바라요`,
              `${t} 이 노래가 당신에게 전해지길 바랍니다`),
            e(`${atmo} 이 빛 속에서 ${feeling}이 가득 차오르는 것 같아`,
              `${atmo} 이 빛 속에서 ${feeling}이 가득 차오르는 것 같아요`,
              `${atmo} 이 빛 속에서 ${feeling}이 가득 차오르는 것 같습니다`),
        ];

        // ── Pre-Chorus: 감정이 터지기 직전 + 연령층 말투 ──
        const preShort = [
            e('이제 더 이상', '이제 더 이상', '이제 더 이상'),
            e('참을 수 없어', '참을 수 없어요', '참을 수 없습니다'),
            e('말해야 할 것 같아', '말해야 할 것 같아요', '말해야 할 것 같습니다'),
            e('지금이 그 순간이야', '지금이 그 순간이에요', '지금이 그 순간입니다'),
        ];
        const preMedium = [
            e('이 마음을 더 이상 숨길 수가 없어',           '이 마음을 더 이상 숨길 수가 없어요',           '이 마음을 더 이상 숨길 수가 없습니다'),
            e('지금 말하지 않으면 후회할 것 같아',          '지금 말하지 않으면 후회할 것 같아요',          '지금 말하지 않으면 후회할 것 같습니다'),
            e('조금만 더 가면 거기에 네가 있을 것 같아',    '조금만 더 가면 거기에 있을 것 같아요',         '조금만 더 가면 거기에 있을 것 같습니다'),
            e('이 감정이 진짜라는 걸 이제는 알겠어',        '이 감정이 진짜라는 걸 이제는 알겠어요',        '이 감정이 진짜라는 걸 이제는 알겠습니다'),
        ];
        const preLong = [
            e('이 마음을 더 이상 숨길 수 없어서 이제는 말하려고 해',
              '이 마음을 더 이상 숨길 수 없어서 이제는 말하려고 해요',
              '이 마음을 더 이상 숨길 수 없어서 이제는 말하려고 합니다'),
            e('지금 이 순간을 놓치면 다시는 기회가 없을 것 같아',
              '지금 이 순간을 놓치면 다시는 기회가 없을 것 같아요',
              '지금 이 순간을 놓치면 다시는 기회가 없을 것 같습니다'),
        ];

        // ── Bridge: 깨달음과 전환점 + 연령층 말투 ──
        const bridgeShort = [
            e('이제야 알겠어', '이제야 알겠어요', '이제야 알겠습니다'),
            e('처음부터였어', '처음부터였어요', '처음부터였습니다'),
            e('결국엔 너야', '결국엔 당신이에요', '결국엔 당신이었습니다'),
            e('돌아보면', '돌아보면', '돌아보면'),
        ];
        const bridgeMedium = [
            e('이제야 알겠어 그 모든 게 너로 이어지고 있었다는 걸',
              '이제야 알겠어요 그 모든 게 당신으로 이어지고 있었다는 걸',
              '이제야 알겠습니다 그 모든 게 당신으로 이어지고 있었다는 걸'),
            e('돌아보면 항상 그 자리에 네가 있었어',
              '돌아보면 항상 그 자리에 당신이 있었어요',
              '돌아보면 항상 그 자리에 당신이 있었습니다'),
            e('처음부터 너였을지도 몰라 이 감정이',
              '처음부터 당신이었을지도 몰라요 이 감정이',
              '처음부터 당신이었을지도 모릅니다 이 감정이'),
            e('힘들었던 그 시간들이 결국 여기로 이어졌어',
              '힘들었던 그 시간들이 결국 여기로 이어졌어요',
              '힘들었던 그 시간들이 결국 여기로 이어졌습니다'),
        ];
        const bridgeLong = [
            e('이제야 알겠어 처음부터 네가 이 노래의 주인공이었다는 걸',
              '이제야 알겠어요 처음부터 당신이 이 노래의 주인공이었다는 걸',
              '이제야 알겠습니다 처음부터 당신이 이 노래의 주인공이었다는 걸'),
            e('돌아보면 항상 그 자리에 네가 있었어 내가 보지 못했던 것뿐이야',
              '돌아보면 항상 그 자리에 당신이 있었어요 제가 보지 못했던 것뿐이에요',
              '돌아보면 항상 그 자리에 당신이 있었습니다 제가 보지 못했던 것뿐입니다'),
        ];

        // ── Rap: 직접적이고 솔직한 고백 + 연령층 말투 ──
        const rapShort = [
            e('솔직히 말할게', '솔직히 말할게요', '솔직히 말씀드릴게요'),
            e('들어봐 잠깐', '들어봐요 잠깐', '들어보세요 잠깐'),
        ];
        const rapMedium = [
            e('솔직하게 말할게 이 감정이 뭔지 나도 몰랐어 근데 이제는 알아',
              '솔직하게 말할게요 이 감정이 뭔지 몰랐는데 이제는 알겠어요',
              '솔직하게 말씀드릴게요 이 감정이 무엇인지 이제는 알겠습니다'),
            e('말하지 못한 것들이 노래가 됐어 이 멜로디에 다 담겨있어',
              '말하지 못한 것들이 노래가 됐어요 이 멜로디에 다 담겨있어요',
              '말하지 못한 것들이 노래가 됐습니다 이 멜로디에 다 담겨있습니다'),
        ];
        const rapLong = [
            e('이 노래 전부가 너한테 하고 싶었던 말들이야 이제 들어봐',
              '이 노래 전부가 당신에게 하고 싶었던 말들이에요 이제 들어봐요',
              '이 노래 전부가 당신께 하고 싶었던 말들입니다 이제 들어보세요'),
        ];

        // ── Hook: 짧고 강렬하게 + 연령층 말투 ──
        const hookShort  = [e(`${t}`, `${t}`, `${t}`)];
        const hookMedium = [e(`${t} 이 노래가 네게 닿기를`, `${t} 이 노래가 당신께 닿기를`, `${t} 이 노래가 당신께 닿기를`)];
        const hookLong   = [e(`${t} 이 마음이 전해지기를 이 노래가 네게 닿기를`,
                              `${t} 이 마음이 전해지기를 이 노래가 당신께 닿기를`,
                              `${t} 이 마음이 전해지기를 이 노래가 당신께 닿기를`)];

        // ── Outro: 마무리 + 연령층 말투 ──
        const outroShort = [
            e(t, t, t),
            e('기억할게', '기억할게요', '기억하겠습니다'),
            e('항상 여기', '항상 여기', '항상 여기'),
        ];
        const outroMedium = [
            e(`${t} 이 멜로디가 오래 남아있을게`,           `${t} 이 멜로디가 오래 남아있을게요`,           `${t} 이 멜로디가 오래 남아있겠습니다`),
            e(`${feeling}이 담긴 이 노래 기억해줘`,         `${feeling}이 담긴 이 노래 기억해줘요`,         `${feeling}이 담긴 이 노래 기억해주세요`),
        ];
        const outroLong = [
            e(`${t} 이 노래와 함께했던 순간을 오래오래 기억해줘`,
              `${t} 이 노래와 함께했던 순간을 오래오래 기억해줘요`,
              `${t} 이 노래와 함께했던 순간을 오래오래 기억해주세요`),
        ];

        return {
            Verse:          { short: verseShort,  medium: verseMedium,  long: verseLong  },
            'Pre-Chorus':   { short: preShort,    medium: preMedium,    long: preLong    },
            Chorus:         { short: [t, `${t} 들려`, e('이 순간','이 순간','이 순간')], medium: chorusMedium, long: chorusLong },
            ...
            'Post-Chorus':  { short: [e('오 오 오','오 오 오','오 오 오')], medium: [e('오 오 오 예','오 오 오 예','오 오 오 예')], long: ['나 나 나 나 나'] },
